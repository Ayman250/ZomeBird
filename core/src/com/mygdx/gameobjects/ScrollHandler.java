...
public class ScrollHandler {
    ...
    //ScrollHandler will create all five objects taht we need.
    private Grass frontGrass, backGrass;
    private Pipe pipe1, pipe2, pipe3;

    //ScrollHandler will use the constants below to determine
    //how fast we need to scroll and also determines
    //the size of the gap between each pair of pipes.

    //Caprical letters are used by convention when naming constants.
    public static final int SCROLL_SPEED = -59;
    public static final int PIPE_GAP = 49;

    //Constructor recieves a float that tells us where we need to create our
